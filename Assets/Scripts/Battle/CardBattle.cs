...
public class CardBattle : MonoBehaviour
{
    ...
    {
        _playerCards.ForEach(_playerCard => { _playerCard.Reset(); });
    ...
    private void StartTeamBattle()
    {
        ...
        StartCoroutine(TeamBattleCoroutine());
    }
    ...
    private IEnumerator DuelCoroutine()
    {
        ...
        {
            SoundManager.Instance.MakeSound(SoundType.Lose);
    ...
    private IEnumerator TeamBattleCoroutine() 
    {
